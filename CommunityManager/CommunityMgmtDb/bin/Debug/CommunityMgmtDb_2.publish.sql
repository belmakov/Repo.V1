...
GO
PRINT N'Creating [dbo].[FK_Amenity_ToAmenityTypes]...';


GO
ALTER TABLE [dbo].[Amenity] WITH NOCHECK
    ADD CONSTRAINT [FK_Amenity_ToAmenityTypes] FOREIGN KEY ([AmenityTypeId]) REFERENCES [dbo].[AmenityType] ([_Id]);
...
GO
PRINT N'Creating [dbo].[FK_Regions_ToRegionTypes]...';


GO
ALTER TABLE [dbo].[Regions] WITH NOCHECK
    ADD CONSTRAINT [FK_Regions_ToRegionTypes] FOREIGN KEY ([RegionTypeId]) REFERENCES [dbo].[RegionType] ([_Id]);
